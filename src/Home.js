...
function Home() {
  ...
  return (
    <div>
        <div style={{width:"100%",height:"500vh", border:"1px solid black", display:"grid", gridTemplateColumns:"repeat(3,1fr)"}}>

       
    {

        value.map((items)=>(
            <div style={{width:"70%",height:"90vh", border:"1px solid black", borderRadius:"10px"}}>
